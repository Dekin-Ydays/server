        ...
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    auth
                            ...
                            .requestMatchers(HttpMethod.POST, "/socialPost/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.POST, "/commentary/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.POST, "/api/v1/subscribes/").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.POST, "/like/**").hasAnyRole("Admin", "AuthService", "User")

                            .requestMatchers(HttpMethod.GET, "/categories/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/api/v1/users/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/socialPost/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/commentary/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/api/v1/subscribes/").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/like/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.GET, "/videos/").hasAnyRole("Admin", "AuthService", "User")

                            .requestMatchers(HttpMethod.PATCH, "/api/v1/users/me/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.PATCH, "/api/v1/users/**").hasAnyRole("Admin", "AuthService")
                            .requestMatchers(HttpMethod.PATCH, "/socialPost/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.PATCH, "/commentary/**").hasAnyRole("Admin", "AuthService", "User")

                            .requestMatchers(HttpMethod.DELETE, "/socialPost/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.DELETE, "/commentary/**").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.DELETE, "/api/v1/subscribes/").hasAnyRole("Admin", "AuthService", "User")
                            .requestMatchers(HttpMethod.DELETE, "/like/**").hasAnyRole("Admin", "AuthService", "User")
